...
.PHONY: help clean html htmlview dirhtml singlehtml pickle json htmlhelp qthelp devhelp epub latex latexpdf text man changes linkcheck doctest gettext update_docs_source
...
update_docs_source:
	@echo "Updating docs source..."
	@rm -rf intro
	@svn export https://github.com/django/django/branches/stable/$(DJANGO_VERSION)/docs/intro intro
	@echo "Reworking links and references..."
	@./update_links

gettext: update_docs_source
